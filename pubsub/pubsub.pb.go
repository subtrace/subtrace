...
func (x *PublishEvents) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*PublishEvents) ProtoMessage() {}

func (x *PublishEvents) ProtoReflect() protoreflect.Message {
	mi := &file_pubsub_pubsub_proto_msgTypes[2]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use PublishEvents.ProtoReflect.Descriptor instead.
func (*PublishEvents) Descriptor() ([]byte, []int) {
...
type AnnounceStats struct {
	...
	// Types that are assignable to Concrete:
	//
	//	*AnnounceStats_ConcreteV1
	Concrete isAnnounceStats_Concrete `protobuf_oneof:"concrete"`
}

func (x *AnnounceStats) Reset() {
	*x = AnnounceStats{}
	if protoimpl.UnsafeEnabled {
...
func (x *AnnounceStats) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*AnnounceStats) ProtoMessage() {}

func (x *AnnounceStats) ProtoReflect() protoreflect.Message {
	mi := &file_pubsub_pubsub_proto_msgTypes[5]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use AnnounceStats.ProtoReflect.Descriptor instead.
func (*AnnounceStats) Descriptor() ([]byte, []int) {
	return file_pubsub_pubsub_proto_rawDescGZIP(), []int{5}
}

func (m *AnnounceStats) GetConcrete() isAnnounceStats_Concrete {
	if m != nil {
		return m.Concrete
	}
	return nil
...
func (x *AnnounceStats) GetConcreteV1() *AnnounceStats_V1 {
	if x, ok := x.GetConcrete().(*AnnounceStats_ConcreteV1); ok {
		return x.ConcreteV1
	}
	return nil
}

type isAnnounceStats_Concrete interface {
	isAnnounceStats_Concrete()
}

type AnnounceStats_ConcreteV1 struct {
	ConcreteV1 *AnnounceStats_V1 `protobuf:"bytes,1,opt,name=concrete_v1,json=concreteV1,proto3,oneof"`
}

func (*AnnounceStats_ConcreteV1) isAnnounceStats_Concrete() {}
...
func (*Message) Descriptor() ([]byte, []int) {
	return file_pubsub_pubsub_proto_rawDescGZIP(), []int{6}
}
...
type JoinPublisher_Request struct {
	...
	LinkIdOverride *string `protobuf:"bytes,1,opt,name=link_id_override,json=linkIdOverride,proto3,oneof" json:"link_id_override,omitempty"`
}
...
func (x *JoinPublisher_Request) GetLinkIdOverride() string {
	if x != nil && x.LinkIdOverride != nil {
		return *x.LinkIdOverride
	}
	return ""
}
...
type PublishEvents_Request struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields
...
func (x *PublishEvents_Request) Reset() {
	*x = PublishEvents_Request{}
	if protoimpl.UnsafeEnabled {
...
func (x *PublishEvents_Request) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*PublishEvents_Request) ProtoMessage() {}

func (x *PublishEvents_Request) ProtoReflect() protoreflect.Message {
	mi := &file_pubsub_pubsub_proto_msgTypes[11]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use PublishEvents_Request.ProtoReflect.Descriptor instead.
func (*PublishEvents_Request) Descriptor() ([]byte, []int) {
	return file_pubsub_pubsub_proto_rawDescGZIP(), []int{2, 0}
}

func (x *PublishEvents_Request) GetEvents() []*Event {
	if x != nil {
		return x.Events
	}
	return nil
...
type PublishEvents_Response struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields
...
func (x *PublishEvents_Response) Reset() {
	*x = PublishEvents_Response{}
	if protoimpl.UnsafeEnabled {
...
func (x *PublishEvents_Response) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*PublishEvents_Response) ProtoMessage() {}

func (x *PublishEvents_Response) ProtoReflect() protoreflect.Message {
	mi := &file_pubsub_pubsub_proto_msgTypes[12]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use PublishEvents_Response.ProtoReflect.Descriptor instead.
func (*PublishEvents_Response) Descriptor() ([]byte, []int) {
	return file_pubsub_pubsub_proto_rawDescGZIP(), []int{2, 1}
}

func (x *PublishEvents_Response) GetError() string {
	if x != nil && x.Error != nil {
		return *x.Error
	}
	return ""
...
func (x *Event_Log) GetLines() []string {
	if x != nil {
		return x.Lines
	}
	return nil
...
func (x *Event_Log) GetIndex() uint64 {
	if x != nil {
		return x.Index
	}
	return 0
...
type Event_V1 struct {
	...
	Log          *Event_Log        `protobuf:"bytes,3,opt,name=log,proto3" json:"log,omitempty"`
}
...
func (*Event_V1) Descriptor() ([]byte, []int) {
	return file_pubsub_pubsub_proto_rawDescGZIP(), []int{3, 1}
}
...
func (x *Event_V1) GetLog() *Event_Log {
	if x != nil {
		return x.Log
	}
	return nil
...
func (x *SetSubscriberConfig_V1) Reset() {
	*x = SetSubscriberConfig_V1{}
	if protoimpl.UnsafeEnabled {
		mi := &file_pubsub_pubsub_proto_msgTypes[16]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (x *SetSubscriberConfig_V1_Call) Reset() {
	*x = SetSubscriberConfig_V1_Call{}
	if protoimpl.UnsafeEnabled {
		mi := &file_pubsub_pubsub_proto_msgTypes[17]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*SetSubscriberConfig_V1_Call) Descriptor() ([]byte, []int) {
	return file_pubsub_pubsub_proto_rawDescGZIP(), []int{4, 0, 0}
}
...
func (x *SetSubscriberConfig_V1_Result) Reset() {
	*x = SetSubscriberConfig_V1_Result{}
	if protoimpl.UnsafeEnabled {
		mi := &file_pubsub_pubsub_proto_msgTypes[18]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*SetSubscriberConfig_V1_Result) Descriptor() ([]byte, []int) {
	return file_pubsub_pubsub_proto_rawDescGZIP(), []int{4, 0, 1}
}
...
type AnnounceStats_V1 struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields

	NumPublishers  uint64 `protobuf:"varint,1,opt,name=num_publishers,json=numPublishers,proto3" json:"num_publishers,omitempty"`
	NumSubscribers uint64 `protobuf:"varint,2,opt,name=num_subscribers,json=numSubscribers,proto3" json:"num_subscribers,omitempty"`
}

func (x *AnnounceStats_V1) Reset() {
	*x = AnnounceStats_V1{}
	if protoimpl.UnsafeEnabled {
		mi := &file_pubsub_pubsub_proto_msgTypes[19]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}

func (x *AnnounceStats_V1) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*AnnounceStats_V1) ProtoMessage() {}

func (x *AnnounceStats_V1) ProtoReflect() protoreflect.Message {
	mi := &file_pubsub_pubsub_proto_msgTypes[19]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use AnnounceStats_V1.ProtoReflect.Descriptor instead.
func (*AnnounceStats_V1) Descriptor() ([]byte, []int) {
	return file_pubsub_pubsub_proto_rawDescGZIP(), []int{5, 0}
}

func (x *AnnounceStats_V1) GetNumPublishers() uint64 {
	if x != nil {
...
func (x *AnnounceStats_V1) GetNumSubscribers() uint64 {
	if x != nil {
		return x.NumSubscribers
	}
	return 0
}
...
func (x *Message_V1) Reset() {
	*x = Message_V1{}
	if protoimpl.UnsafeEnabled {
		mi := &file_pubsub_pubsub_proto_msgTypes[20]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*Message_V1) Descriptor() ([]byte, []int) {
	return file_pubsub_pubsub_proto_rawDescGZIP(), []int{6, 0}
}
...
func (x *Message_V1) GetAnnounceStats() *AnnounceStats {
	if x, ok := x.GetUnderlying().(*Message_V1_AnnounceStats); ok {
		return x.AnnounceStats
	}
	return nil
}
...
type Message_V1_AnnounceStats struct {
	AnnounceStats *AnnounceStats `protobuf:"bytes,3,opt,name=announce_stats,json=announceStats,proto3,oneof"`
}
...
func (*Message_V1_AnnounceStats) isMessage_V1_Underlying() {}
...
var file_pubsub_pubsub_proto_rawDesc = []byte{
	...
	,
	...
	0x18, 0x01, 0x20, 0x01, 0x28, 0x09, 0x52, 0x0c, 0x77, 0x65, 0x62, 0x73, 0x6f, 0x63, 0x6b, 0x65,
	0x74, 0x55, 0x72, 0x6c, 0x42, 0x08, 0x0a, 0x06, 0x5f, 0x65, 0x72, 0x72, 0x6f, 0x72, 0x22, 0xab,
	0x01, 0x0a, 0x0e, 0x4a, 0x6f, 0x69, 0x6e, 0x53, 0x75, 0x62, 0x73, 0x63, 0x72, 0x69, 0x62, 0x65,
	0x72, 0x1a, 0x42, 0x0a, 0x07, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x12, 0x26, 0x0a, 0x0c,
	...
	,
	...
	,
	...
	0x2e, 0x43, 0x61, 0x6c, 0x6c, 0x48, 0x00, 0x52, 0x04, 0x63, 0x61, 0x6c, 0x6c, 0x12, 0x48, 0x0a,
	...
	,
	...
	,
...
var file_pubsub_pubsub_proto_msgTypes = make([]protoimpl.MessageInfo, 21)
var file_pubsub_pubsub_proto_goTypes = []any{
	...
	(*PublishEvents)(nil),                 // 2: subtrace.pubsub.PublishEvents
	(*Event)(nil),                         // 3: subtrace.pubsub.Event
	(*SetSubscriberConfig)(nil),           // 4: subtrace.pubsub.SetSubscriberConfig
	(*AnnounceStats)(nil),                 // 5: subtrace.pubsub.AnnounceStats
	(*Message)(nil),                       // 6: subtrace.pubsub.Message
	(*JoinPublisher_Request)(nil),         // 7: subtrace.pubsub.JoinPublisher.Request
	(*JoinPublisher_Response)(nil),        // 8: subtrace.pubsub.JoinPublisher.Response
	(*JoinSubscriber_Request)(nil),        // 9: subtrace.pubsub.JoinSubscriber.Request
	(*JoinSubscriber_Response)(nil),       // 10: subtrace.pubsub.JoinSubscriber.Response
	(*PublishEvents_Request)(nil),         // 11: subtrace.pubsub.PublishEvents.Request
	(*PublishEvents_Response)(nil),        // 12: subtrace.pubsub.PublishEvents.Response
	(*Event_Log)(nil),                     // 13: subtrace.pubsub.Event.Log
	(*Event_V1)(nil),                      // 14: subtrace.pubsub.Event.V1
	nil,                                   // 15: subtrace.pubsub.Event.V1.TagsEntry
	(*SetSubscriberConfig_V1)(nil),        // 16: subtrace.pubsub.SetSubscriberConfig.V1
	(*SetSubscriberConfig_V1_Call)(nil),   // 17: subtrace.pubsub.SetSubscriberConfig.V1.Call
	(*SetSubscriberConfig_V1_Result)(nil), // 18: subtrace.pubsub.SetSubscriberConfig.V1.Result
	(*AnnounceStats_V1)(nil),              // 19: subtrace.pubsub.AnnounceStats.V1
	(*Message_V1)(nil),                    // 20: subtrace.pubsub.Message.V1
}
var file_pubsub_pubsub_proto_depIdxs = []int32{
	14, // 0: subtrace.pubsub.Event.concrete_v1:type_name -> subtrace.pubsub.Event.V1
	16, // 1: subtrace.pubsub.SetSubscriberConfig.concrete_v1:type_name -> subtrace.pubsub.SetSubscriberConfig.V1
	19, // 2: subtrace.pubsub.AnnounceStats.concrete_v1:type_name -> subtrace.pubsub.AnnounceStats.V1
	20, // 3: subtrace.pubsub.Message.concrete_v1:type_name -> subtrace.pubsub.Message.V1
	3,  // 4: subtrace.pubsub.PublishEvents.Request.events:type_name -> subtrace.pubsub.Event
	15, // 5: subtrace.pubsub.Event.V1.tags:type_name -> subtrace.pubsub.Event.V1.TagsEntry
	13, // 6: subtrace.pubsub.Event.V1.log:type_name -> subtrace.pubsub.Event.Log
	17, // 7: subtrace.pubsub.SetSubscriberConfig.V1.call:type_name -> subtrace.pubsub.SetSubscriberConfig.V1.Call
	18, // 8: subtrace.pubsub.SetSubscriberConfig.V1.result:type_name -> subtrace.pubsub.SetSubscriberConfig.V1.Result
	3,  // 9: subtrace.pubsub.Message.V1.event:type_name -> subtrace.pubsub.Event
	4,  // 10: subtrace.pubsub.Message.V1.set_subscriber_config:type_name -> subtrace.pubsub.SetSubscriberConfig
	5,  // 11: subtrace.pubsub.Message.V1.announce_stats:type_name -> subtrace.pubsub.AnnounceStats
...
func file_pubsub_pubsub_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_pubsub_pubsub_proto_msgTypes[11].Exporter = func(v any, i int) any {
			switch v := v.(*PublishEvents_Request); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_pubsub_pubsub_proto_msgTypes[12].Exporter = func(v any, i int) any {
			switch v := v.(*PublishEvents_Response); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_pubsub_pubsub_proto_msgTypes[16].Exporter = func(v any, i int) any {
		...
		file_pubsub_pubsub_proto_msgTypes[17].Exporter = func(v any, i int) any {
		...
		file_pubsub_pubsub_proto_msgTypes[18].Exporter = func(v any, i int) any {
		...
		file_pubsub_pubsub_proto_msgTypes[19].Exporter = func(v any, i int) any {
			switch v := v.(*AnnounceStats_V1); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_pubsub_pubsub_proto_msgTypes[20].Exporter = func(v any, i int) any {
	...
	file_pubsub_pubsub_proto_msgTypes[9].OneofWrappers = []any{}
	file_pubsub_pubsub_proto_msgTypes[10].OneofWrappers = []any{}
	file_pubsub_pubsub_proto_msgTypes[12].OneofWrappers = []any{}
	file_pubsub_pubsub_proto_msgTypes[16].OneofWrappers = []any{
		(*SetSubscriberConfig_V1_Call_)(nil),
		(*SetSubscriberConfig_V1_Result_)(nil),
	}
	file_pubsub_pubsub_proto_msgTypes[18].OneofWrappers = []any{}
	file_pubsub_pubsub_proto_msgTypes[20].OneofWrappers = []any{
		(*Message_V1_Event)(nil),
		(*Message_V1_SetSubscriberConfig)(nil),
		(*Message_V1_AnnounceStats)(nil),
	}
	type x struct{}
